...
Предметы добавляются динамически, время добавления регулируется. Сила увеличения хп/урона случайна в диапазоне.
Урон каждого сгенерированного противника отличается. 

Интерфейс с кнопками статы/инвентарь - заглушка.
Также кнопка Сгенерировать карту потеряла свою актуальность.
Игра на паузе позволяет игроку по сути телепортироваться (поставить игру на паузу - игровое время замирает, но двигаться игрок может (не баг, а фича)).
